package com.vilelo.ws.withdrawal_service.config;


import java.util.HashMap;
import java.util.Map;

import com.vilelo.ws.core.error.NotRetryableException;
import com.vilelo.ws.core.error.RetryableException;
